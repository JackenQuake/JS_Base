...
let tmp1 = document.querySelector(".products");
...
function clickHandler(event) {
    ...
    // let str = event.target.dataset.type;
    // console.log(str);
    // showCategory(str);
...
function showCategory(category) {
    ...
    products[category].forEach(function (a) {
        tmp2 += getProductMarkup(a);
    });
    tmp1.insertAdjacentHTML("afterBegin", tmp2);
}
